...
<body>
	...
	<form id="itemForm" action="${pageContext.request.contextPath }/product/updateProduct"
		...
		<table width="100%" border=1>
			...
			<tr>
				...
				<td><c:if test="${items.pic !=null}">
						<img src="${pageContext.request.contextPath}/upload-img/${items.pic}" width=100 height=100 />
						<br />
